...
- 👋 Hi there, I'm Felix Ugwunna, a Cloud and DevOps enthusiast working with Connexxion Telecoms as Cloud Admininstrator a passion for automating simple and complex processes in the cloud. 👀 I'm particularly interested in exploring the latest technologies and tools in the cloud and DevOps space to continuously improve my skills and knowledge. 🌱 Currently, I'm expanding my knowledge in DevOps practices and how it can be leveraged to improve cloud infrastructure and application deployment, 💞️ I'm open to collaborating on any cloud and DevOps related projects that align with my interests and skills.
